...
<?php
  include 'koneksi.php';
    ...
    if (isset($_GET['detaillaporan'])) {
        $id_laporan = $_GET['detaillaporan'];
        // echo $id_laporan;
            ...
            <div class="container">
              <form method="POST" action="proseslaporan.php" enctype="multipart/form-data">
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <select disabled name="id_klasifikasi" class="form-control" required>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <input disabled value="<?= $judul_laporan; ?>" required type="text" name="judul_laporan" class="form-control" id="judul_laporan" placeholder="Judul Laporan" />
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <textarea disabled required name="isi_laporan" class="form-control" id="isi_laporan" rows="3" placeholder="Ex: Ini adalah runtut kejadian ..."><?= $isi_laporan; ?></textarea>
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <select disabled name="id_kategori" class="form-control" required>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <input disabled value="<?= $email; ?>" required type="email" name="email" class="form-control" id="email" placeholder="zzzzz@gmail.com" />
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <input disabled value="<?= $no_whatsapp; ?>" required type="text" name="no_whatsapp" class="form-control" id="no_whatsapp" placeholder="08...." />
                  </div>
                </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-sm-9">
                    <input disabled value="<?= $tanggal_kejadian; ?>" required type="date" name="tanggal_kejadian" class="form-control" id="tanggal_kejadian" placeholder="" />
                  </div>
                </div>
