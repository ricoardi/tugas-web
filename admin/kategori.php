<?php
      ...
      WHERE tb_kategori.deleted_at IS NULL
      ";
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            ...
            <a href="kelolakategori.php" type="button" class="btn btn-primary mb-3 float-right">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $result['ket_kategori']; ?></td>
              <!-- <td> <a href="proseskategori.php?valid=<?php echo $result['id_kategori']; ?>" type="button" class="btn btn-success btn-sm" onClick="return confirm('Apakah anda yakin ingin mengubah status data tersebut menjadi VALID ?')"><i class="fas fa-check-circle"> Valid</i></a>
                      <a href="proseskategori.php?notvalid=<?php echo $result['id_kategori']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin mengubah status data tersebut menjadi TIDAK VALID ?')"><i class="fas fa-times-circle"></i> Tidak Valid</i></a>
                    </td> -->
                    <td><?php if($result['status_kategori'] == '1'){
                      echo 'Aktif';
                    }else{
                      echo 'Tidak Aktif';
                      } ?></td>
                    <td>
                      <a href="kelolakategori.php?ubahkategori=<?php echo $result['id_kategori']; ?>" type="button" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"> Ubah</i></a> <br><br>
                      <a href="proseskategori.php?hapuskategori=<?php echo $result['id_kategori']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')"><i class="fas fa-trash-alt"> Hapus</i></a>
                    </td>
                    </tr>
                    <?php } ?>
              </tbody>
    ...
    <!-- <section class="content">
      <div class="container-fluid">
        ...
        <br>
          <center>
            <a target="_blank" href="exportkategori.php" type="button" class="btn btn-info btn-xl" onClick="return confirm('Apakah anda yakin ingin Mengunduh kategori ?')"><i class="fas fa-file-download"> Unduh Rekap kategori</i></a>
