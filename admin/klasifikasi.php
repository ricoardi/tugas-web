<?php
      ...
      $query = 
      "SELECT * FROM tb_klasifikasi 
      
      WHERE tb_klasifikasi.deleted_at IS NULL
      ";
  ...
  <div class="content-wrapper">
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            ...
            <a href="kelolaklasifikasi.php" type="button" class="btn btn-primary mb-3 float-right">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $result['ket_klasifikasi']; ?></td>
              <!-- <td> <a href="prosesklasifikasi.php?valid=<?php echo $result['id_klasifikasi']; ?>" type="button" class="btn btn-success btn-sm" onClick="return confirm('Apakah anda yakin ingin mengubah status data tersebut menjadi VALID ?')"><i class="fas fa-check-circle"> Valid</i></a>
                      <a href="prosesklasifikasi.php?notvalid=<?php echo $result['id_klasifikasi']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin mengubah status data tersebut menjadi TIDAK VALID ?')"><i class="fas fa-times-circle"></i> Tidak Valid</i></a>
                    </td> -->
                    <td><?php if($result['status_klasifikasi'] == '1'){
                      echo 'Aktif';
                    }else{
                      echo 'Tidak Aktif';
                      } ?></td>
                    <td>
                      <a href="kelolaklasifikasi.php?ubahklasifikasi=<?php echo $result['id_klasifikasi']; ?>" type="button" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"> Ubah</i></a> <br><br>
                      <a href="prosesklasifikasi.php?hapusklasifikasi=<?php echo $result['id_klasifikasi']; ?>" type="button" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data tersebut?')"><i class="fas fa-trash-alt"> Hapus</i></a>
                    </td>
                    </tr>
                    <?php } ?>
              </tbody>
    ...
    <!-- <section class="content">
      <div class="container-fluid">
        ...
        <br>
          <center>
            <a target="_blank" href="exportklasifikasi.php" type="button" class="btn btn-info btn-xl" onClick="return confirm('Apakah anda yakin ingin Mengunduh Klasifikasi ?')"><i class="fas fa-file-download"> Unduh Rekap Klasifikasi</i></a>
